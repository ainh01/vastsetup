...
# MODEL UPDATE: IQ2_M quantization (lightest)
readonly MODEL="${MODEL_DIR}/Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-IQ2_M.gguf"
...
readonly MODEL_URL="https://huggingface.co/HauhauCS/Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-MTP-GGUF/resolve/main/Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-IQ2_M.gguf"
...
# UPDATED CONFIG: ctx-size 100000, IQ2_M model
server_args=(
    --model "${MODEL}"
