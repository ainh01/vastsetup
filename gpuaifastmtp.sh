...
readonly MODEL="${MODEL_DIR}/Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-Q6_K_P.gguf"
readonly MMPROJ="${MODEL_DIR}/mmproj-Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-BF16.gguf"
...
readonly MODEL_URL="https://huggingface.co/HauhauCS/Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-MTP-GGUF/resolve/main/Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-Q6_K_P.gguf"
readonly MMPROJ_URL="https://huggingface.co/HauhauCS/Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-MTP-GGUF/resolve/main/mmproj-Qwen3.8-27B-Uncensored-HauhauCS-Aggressive-BF16.gguf"
...
download_gguf "${MMPROJ_URL}" "${MMPROJ}" "Vision projector"
...
valid_gguf "${MMPROJ}" ||
    die "Vision projector failed final validation immediately before startup."
